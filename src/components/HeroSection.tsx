  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[url('/lovable-uploads/bb95c410-d1f9-4352-9277-e8f9bcff37ab.png')] bg-cover bg-center opacity-10"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden transform rotate-1 card-shadow">
              <img 
                src="/lovable-uploads/bb95c410-d1f9-4352-9277-e8f9bcff37ab.png" 
